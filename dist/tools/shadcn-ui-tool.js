...
export class readUsageDocTool extends BaseTool {
    constructor() {
        super(...arguments);
        this.name = "read-usage-doc";
        this.description = "read usage doc of a component， Use this tool when mentions /usedoc.";
        // 参数定义
...
export class readFullDocTool extends BaseTool {
    constructor() {
        super(...arguments);
        this.name = "read-full-doc";
        this.description = "read full doc of a component, Use this tool when mentions /doc.";
        // 参数定义
        this.schema = z.object({
            name: z.string().describe("name of the component, lowercase, kebab-case"),
        });
